    ...
    <div class="container">
        <div class="row"> 
            <div class="col-lg-5 shadow rounded">
                <p class="fs-3 text-warning"> User Registration </p>
...
<script>
    ...
    data(){
        return{
            ...
            registerURL:"https://nodejs-mtn.onrender.com/user/register",
            name: "",
            email : "",
            phonenumber : "",
            password : "",
    ...
    methods:{
           signup(){
                ...
                let obj = {name:this.name, email:this.email, phonenumber:this.phonenumber, password:this.password, databalance:0}
                //console.log(obj);
